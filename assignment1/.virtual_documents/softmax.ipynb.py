...
print('sanity check: get_ipython().run_line_magic("f'", " % (-np.log(0.1)))")
...
print('Loss difference: get_ipython().run_line_magic("f'", " % np.abs(loss_naive - loss_vectorized))")
print('Gradient difference: get_ipython().run_line_magic("f'", " % grad_difference)")
...
print('softmax on raw pixels final test set accuracy: get_ipython().run_line_magic("f'", " % (test_accuracy, ))")
