...
class KNearestNeighbor(object):
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            #########################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            row_i = dists[i,:].reshape(1,-1)[0]
            sort_index = np.argsort(row_i) # Here no need to use negative, because 
                                            # samaller is better  
            kth_near = sort_index[:k]
            closest_y = [self.y_train[i] for i in kth_near]
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            #########################################################################
            # TODO:                                                                 #
            ...
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            # if k == 1:
            #     y_pred[i] = self.y_train[sort_index[0]]
            #     continue
            maxlabel = max(closest_y, key=closest_y.count)
            # print(maxlabel)
            y_pred[i] = maxlabel
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
